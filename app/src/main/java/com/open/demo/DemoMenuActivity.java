...
//		findViewById(R.id.content11).setBackgroundResource(R.drawable.main_bg);
    ...
    private void initAllMenu() {
        ...
        menuItem1.setIconRes(R.mipmap.ic_launcher).setId(R.id.menu_1_1).setChecked(true);
        mOpenMenu.add("菜单2").setIconRes(R.mipmap.ic_launcher).setId(R.id.menu_1_2);
        mOpenMenu.add("菜单3").setIconRes(R.mipmap.ic_launcher).setId(R.id.menu_1_3);
        mOpenMenu.add("菜单4").setIconRes(R.mipmap.ic_launcher).setId(R.id.menu_1_4);
        mOpenMenu.add("菜单5").setIconRes(R.mipmap.ic_launcher).setId(R.id.menu_1_5);
        mOpenMenu.add("菜单6").setIconRes(R.mipmap.ic_launcher);
        mOpenMenu.add("菜单7").setIconRes(R.mipmap.ic_launcher);
        // 菜单1的子菜单.
        OpenMenu subMenu1 = new OpenMenuImpl();
        subMenu1.add("菜单1-1");
        subMenu1.add("菜单1-2").setIconRes(R.mipmap.ic_launcher);
        subMenu1.add("菜单1-3");
        // 菜单2的子菜单.
